...
{
	TEST_ASSERT_EQUAL(0, SPR0);
	TEST_ASSERT_EQUAL(1, SPR1);
	TEST_ASSERT_EQUAL(2, CPHA);
	TEST_ASSERT_EQUAL(3, CPOL);
	TEST_ASSERT_EQUAL(4, MSTR);
	TEST_ASSERT_EQUAL(5, DORD);
	TEST_ASSERT_EQUAL(6, SPE);
	TEST_ASSERT_EQUAL(7, SPIE);
}

TEST(spi, StatusRegisterConstants)
{
	TEST_ASSERT_EQUAL(0, SPI2X);
	TEST_ASSERT_EQUAL(6, WCOL);
	TEST_ASSERT_EQUAL(7, SPIF);
}
